<div class="panel-body">
    ...
    <div class="cart-list">
        ...
        @foreach($carts as $keyCarts =>$cart)
                            ...
                            <div
                                ...
                                <div class="cart-item-qty">
                                    ...
                                    <input type="text"
                                     class ="input-qty"
                                        value ="{{ $cart->qty }}">
                                        <input type="hidden" name="" class="rowId" value = {{ $cart->rowId }}>
                                    <button type ="button"class="btn-qty plus">+</button>
                                </div>
                                <div class="cart-item-price">
                                  <div class="uk-flex uk-flex-bottom">
                                    {{-- @if ($cart->price != $cart->priceOriginal)
                                    <span class="cart-price-old mr10">  {{ convert_price($cart->price,true) }} đ</span>
                                    @endif --}}
                                  <span class="cart-price-sale">  {{  (count($carts) && !is_null($carts)) ? convert_price($cartCaculate['cartTotal'],true)  :0 }} đ</span>
