...
@include('frontend.component.headerthailam')
<!-- Home section start -->
<section class="home">
    ...
    <div class="swiper home-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide slide" style="background: url({{ asset('backend/img/banner2.jpg') }}) no-repeat;">
                <div class="content">
            ...
            <div class="swiper-slide slide" style="background: url({{ asset('backend/img/banner.jpg') }}) no-repeat;">
                <div class="content">
                    <span>Explore, discovery</span>
                    <a href="package.php" class="btn">Discovery more</a>
                </div>
            ...
            <div class="swiper-slide slide" style="background: url({{ asset('backend/img/banner3.jpg') }}) no-repeat;">
                <div class="content">
                    <span>Explore, discovery</span>
                    <a href="package.php" class="btn">Discovery more</a>
                </div>
    ...
    <div class="carousel">
        ...
        <div class="carousel-track-container">
            <div class="carousel-track">
                <div class="box1">
                    <img src="{{ asset('backend/img/icon3.jpg') }}" alt="Adventure">
                    <h3>SUV</h3>
                </div>
                <div class="box1">
                    <img src="{{ asset('backend/img/icon4.jpg') }}" alt="Tour Guide">
                    <h3>Sport</h3>
                </div>
                <div class="box1">
                    <img src="{{ asset('backend/img/icon5.jpg') }}" alt="Trekking">
                    <h3>Coupe</h3>
                </div>
                <div class="box1">
                    <img src="{{ asset('backend/img/icon6.jpg') }}" alt="Camp Fire">
                    <h3>Luxury</h3>
                </div>
                <div class="box1">
                    <img src="{{ asset('backend/img/icon1.jpg') }}" alt="Adventure">
                    <h3>Sedan</h3>
                </div>
                <div class="box1">
                    <img src="{{ asset('backend/img/icon2.jpg') }}" alt="Adventure">
                    <h3>Classic</h3>
                </div>
            </div>
        </div>
...
<section class="home-about">
    <div class="image">
        <img src="{{ asset('backend/img/about2.jpg') }}" alt="">
    </div>
...
<section class="home-packages">
    ...
    <div class="box-container">
        <div class="box">
            <div class="image">
                <img src="{{ asset('backend/img/car4.jpg') }}" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="image">
                <img src="{{ asset('backend/img/car2.jpg') }}" alt="">
            </div>
            <div class="content">
                <h3>Discovery More</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, fugiat?</p>
        ...
        <div class="box">
            <div class="image">
                <img src="{{ asset('backend/img/car3.jpg') }}" alt="">
            </div>
            <div class="content">
                <h3>Discovery More</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, fugiat?</p>
...
@include('frontend.component.footerthailam')
