            ...
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                ...
                <div class="header-widget">
                    <div class="uk-flex uk-flex-middle">
                        <div class="call-us">Cần hỗ trợ? Gọi cho chúng tôi: <a href="{{ $system['contact_hotline'] }}" title="">{{ $system['contact_hotline'] }}</a></div>
                        @if (isset($languages))
                               <div class="language">
        ...
        <div class="uk-container uk-container-center">
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="uk-flex uk-flex-middle">
                    <div class="logo">
                        <a href="" class="logo-image">
                            <img src="{{ asset('backend/img/logovip.png') }}" alt="">
                        </a>
                    </div>
                ...
                <div class="middle-widget">
                    <div class="uk-flex uk-flex-middle">
                        <a href="{{ route('home.productlam') }}" class="become-vendor">Trở thành đại lý <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        <div class="widget-toolbox uk-flex uk-flex-middle">
                            ...
                            <div class="toolbox-item">
                                <a href="{{ route('auth.admin') }}" title="" class="uk-flex uk-flex-bottom">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <g>
