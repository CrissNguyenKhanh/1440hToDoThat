    ...
    <div class="row">
        <div class="col-lg-4">
                    ...
                    @php
                        $url =
                            session('app_locale') === $language->canonical
                                ...
                                : route('menu.translate', ['languageId' => $language->id ,
                                 'id' =>$id]);
            ...
            <div class="panel-body">
                ...
                <p>Bạn có thể thay đổi vị trí hiển thị của menu bằng cách <span class="text-success"></span>
                    menu đến vị trí mong muốn</p>
                <p>+ Dễ dàng khởi tạo menu con bằng cách ấn vào nút
                    <span class='text-success'>Quản lý menu con</span>
                </p>
                <p><span class="text-danger">+Hỗ trợ danh mục con cấp 5</span> </p>
            ...
            <div class="ibox">
                <div class="ibox-title ">
                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                        ...
                        <a href="{{ route('menu.editMenu', ['id' => $id]) }}" class="custom-button">Cập nhật Menu cấp 1
                        </a>
                    </div>
