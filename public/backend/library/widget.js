(function ($) {
  ...
  HT.setChecked = () => {
    return ` <svg class="svg-next-icon button-selected-combobox svg-next-icon-size-12" width="12" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26">
             <path d="M0.3,14c-0.2-0.2-0.3-0.5-0.3-0.7s0.1-0.5,0.3-0.7c0.4-0.4,1-0.4,1.4,0l0.1,0.1 5.5,5.9c0.2,0.2,0.5,0.2,0.7,0l13.4-13.9h0.1c0.4-0.4,1-0.4,1.4,0,0.4,0.4,0.4,1,0,1.4l-16,16.6c-0.2,0.2-0.4,0.3-0.7,0.3-0.3,0-0.5-0.1-0.7-0.3l-7.8-8.4-0.2-0.3z"></path>
           </svg>`;
  };
  HT.unfocusSearchBox = () => {
    $(document).on("click", "html", function (e) {
      if (
        !$(e.target).hasClass("search-model-box") ||
